...
class CNNClassifier(nn.Module):
    def __init__(self, emb_matrix, vocab, extra_vocab, labels, args):
        ...
        if extra_vocab:
            ...
            self.extra_embedding_dim = args.extra_wordvec_dim
        ...
        # TODO: add other options for handling extra vectors
        self.conv_layers = nn.ModuleList([nn.Conv2d(in_channels=1,
                                                    out_channels=self.config.filter_channels,
                                                    kernel_size=(filter_size, self.embedding_dim + self.extra_embedding_dim))
    ...
    def forward(self, inputs, device=None):
        ...
        if self.extra_vocab:
            ...
            # TODO: at train time, train an extra unk.  At test time, use the extra unk
